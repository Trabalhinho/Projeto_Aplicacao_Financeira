...
class inserir_Dados(object):


    def __init__( self, dt_calendario = "", classificacao = "", localizacao = "", item = "", 
                 banco = "", fl_credito_debito = "", fl_entrada_saida = "", valor_total = "", 
                 qtde_parcelas = "" ):
        self.info = {}
    ...
    def insert( self ):
        ...
        try:
            ...
            return "Ocorreu um erro na inserção do dado"
